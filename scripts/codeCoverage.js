...
(async () => {
  ...
  const coverage = [...calculateUsedBytes('js', jsCoverage), ...calculateUsedBytes('css', cssCoverage)]
  ...
  fs.writeFile('./assets/codeCoverage.json', JSON.stringify(coverage), function (err) {
